    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            FocusScope {
                ...
                // FocusBars render as a left-edge bar rather than a full
                // envelope — subtler, and clear of the scrollbar. Their focus
                // transition and the reason it costs no layout round-trip are
                // documented once, in FocusBar.qml's header; do not restate
                // the mechanism here, because this copy already drifted once
