...
- [Agent ownership inversion (PLANNED)](project/active/agent_ownership_inversion.md) — IDE becomes sole source of truth for its agents; shell→dumb relay; STT direct; orchestrator.nvim removed. See docs/agent-ownership-inversion.md
