...
- [No hook on Esc-interrupt](reference/agent-sdk/no_hook_on_esc_interrupt.md) — Claude fires NO hook on cancel (2.1.170); sparkle sticks; EscapeWatcher fallback in agent_interrupt.py
