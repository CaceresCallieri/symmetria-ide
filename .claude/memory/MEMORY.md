...
- [⚠ Framework pivot → Tauri (2026-06-05)](project/active/framework_pivot.md) — QML→Tauri/React; nvim in xterm.js; which-key IDE gate; see docs/framework-pivot.md. Read before IDE work.
