...
- [QML strict-property on QObject](reference/qt-pyside/qml_strict_property_qobject.md) — `obj.dynProp = fn` silently fails under `pragma ComponentBehavior: Bound`; use a JS map
